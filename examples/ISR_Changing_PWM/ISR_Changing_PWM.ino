...
float PWM_Freq1   = 10.0f;
// You can assign any interval for any timer here, in Hz
float PWM_Freq2   = 20.0f;
...
void loop()
{
  SerialDebug.print(F("Using PWM Freq = "));
  SerialDebug.print(PWM_Freq1);
  SerialDebug.print(F(", PWM DutyCycle = "));
  SerialDebug.println(PWM_DutyCycle1);
  ...
  SerialDebug.print(F("Using PWM Freq = "));
  SerialDebug.print(PWM_Freq2);
  SerialDebug.print(F(", PWM DutyCycle = "));
  SerialDebug.println(PWM_DutyCycle2);
