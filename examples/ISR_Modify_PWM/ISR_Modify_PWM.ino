...
void setup()
{
  ...
  SerialDebug.print(F("\nStarting ISR_Modify_PWM on ")); SerialDebug.println(BOARD_NAME);
  ...
  SerialDebug.print(F("Using PWM Freq = ")); SerialDebug.print(PWM_Freq1); SerialDebug.print(F(", PWM DutyCycle = ")); SerialDebug.println(PWM_DutyCycle1);
...
void changePWM()
{
  ...
  {
    SerialDebug.println(F("modifyPWMChannel error for PWM_Period"));
  }
}
...
#define CHANGING_PWM_INTERVAL    5000L    //10000L
